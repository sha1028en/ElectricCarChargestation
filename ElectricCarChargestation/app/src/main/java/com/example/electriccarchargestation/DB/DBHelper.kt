            ...
            if(cursor.count > 0){
                while(cursor.moveToNext()){
                    var publicData = PublicData(
                        id              = cursor.getInt( 0),
                        stationId       = cursor.getString( 1),
                        chargeAmount    = cursor.getString( 2),
                        chargeType      = cursor.getInt( 3),
                        parkingFree     = cursor.getString( 4),
                        stationName     = cursor.getString( 5),
                        address         = cursor.getString( 6),
                        latitude        = cursor.getFloat( 7),
                        longtitude      = cursor.getFloat( 8),
