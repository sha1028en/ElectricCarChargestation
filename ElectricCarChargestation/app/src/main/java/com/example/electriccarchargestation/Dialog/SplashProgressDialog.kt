...
class SplashProgressDialog(context: Context): Dialog( context) {
    ...
    fun initProgress( progressFront: Int = 0 ,progressRear: Int, default: Int) {
        ...
        this.bind.pgSplashDialogCurrentProgress.progress = default
    }

    fun setCurrentProgress( currentPos: Int) { this.bind.pgSplashDialogCurrentProgress.progress = currentPos }

    fun addCurrentProgress() { this.bind.pgSplashDialogCurrentProgress.progress++ }
}